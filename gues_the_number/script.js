...
// const lowOrHI=document.querySelector('.lowOrHri')
...
// }else if(guess<1){
//     alert('plese enter the heighter value')
// }else if(guess>100){
...
//     displayMassage(`Number is a TOO low `)
// }else if (guess > randomNumber){
//     displayMassage(`Number is a TOO High`)
// }
// }
